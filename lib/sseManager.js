...
function publishToPatient(userId, data) {
  publish(channelFor('patient', userId), 'patient-update', data);
}

function subscribeToPatient(userId, res) {
  subscribe(channelFor('patient', userId), res);
}
